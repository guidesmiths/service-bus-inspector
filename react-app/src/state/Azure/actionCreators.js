...
export const getDlq = createAction(actionTypes.GET_DLQ, content => ({ content }));

export const setDlq = createAction(actionTypes.SET_DLQ, content => ({ content }));

export const deleteDlq = createAction(actionTypes.DELETE_DLQ, content => ({ content }));

export const deleteActive = createAction(actionTypes.DELETE_ACTIVE, content => ({ content }));
...
export const getActive = createAction(actionTypes.GET_ACTIVE, content => ({ content }));

export const setActive = createAction(actionTypes.SET_ACTIVE, content => ({ content }));
...
export const getConnectionString = createAction(actionTypes.GET_CONNECTION_STRING, content => ({ content }));

export const setConnectionString = createAction(actionTypes.SET_CONNECTION_STRING, content => ({ content }));
